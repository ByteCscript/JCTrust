...
/*
 * The JCTrust project was born from a university wish which 
 * is to be able to create an rpg video game, it reflects the work that was done
 *  during the degree, the main idea of the project was thanks to the Hiker's Archive channel.
 */
public class Game extends Canvas implements Runnable {
	private static final long serialVersionUID = 1L;
	private Random random = new Random();
	public static final String NAME = "JCTrust";
	...
	public static void main(String[] args) {
		...
		ImageIcon icon;
		icon = new ImageIcon("res/iconoframe.png");

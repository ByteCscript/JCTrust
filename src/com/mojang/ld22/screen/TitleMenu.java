...
public class TitleMenu extends Menu {
	...
	public void render(Screen screen) {
		...
		//COLOR  fondo - sombreado atras letra  -  contorno letra negro -  parte interna letra
		//int titleColor = Color.get(0, 555, 666, 680);
		int titleColor = Color.get(0, 555, 666, 444);
		...
		Font.draw("    Are you Ready?", screen, 0, screen.h - 110, Color.get(0, 111, 111, 111));
